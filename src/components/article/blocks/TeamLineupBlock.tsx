...
// Formations avec positions (x, y en pourcentage) - CORRIGÉ pour vue TV standard
// Convention: l'équipe attaque vers le bas, donc côté GAUCHE équipe = DROITE écran
// Ordre des joueurs: GK, LB, CB, CB, RB, puis milieux L→R, puis attaquants L→R
const FORMATIONS: Record<string, { x: number; y: number }[]> = {
  '4-3-3': [
    { x: 50, y: 6 },   // GK
    { x: 92, y: 24 }, { x: 67, y: 20 }, { x: 33, y: 20 }, { x: 8, y: 24 }, // DEF: LB(droite écran), CB, CB, RB(gauche écran)
    { x: 80, y: 44 }, { x: 50, y: 40 }, { x: 20, y: 44 }, // MID: LM, CM, RM
    { x: 85, y: 66 }, { x: 50, y: 72 }, { x: 15, y: 66 }, // ATT: LW(droite), ST, RW(gauche)
  ],
  '4-4-2': [
    { x: 50, y: 6 },
    { x: 92, y: 24 }, { x: 67, y: 20 }, { x: 33, y: 20 }, { x: 8, y: 24 },
    { x: 92, y: 46 }, { x: 67, y: 44 }, { x: 33, y: 44 }, { x: 8, y: 46 },
    { x: 65, y: 70 }, { x: 35, y: 70 },
  ],
  '4-2-3-1': [
    { x: 50, y: 6 },
    { x: 92, y: 24 }, { x: 67, y: 20 }, { x: 33, y: 20 }, { x: 8, y: 24 },
    { x: 67, y: 38 }, { x: 33, y: 38 },
    { x: 85, y: 56 }, { x: 50, y: 54 }, { x: 15, y: 56 },
    { x: 50, y: 74 },
  ],
  '3-5-2': [
    { x: 50, y: 6 },
    { x: 80, y: 22 }, { x: 50, y: 18 }, { x: 20, y: 22 },
    { x: 95, y: 44 }, { x: 72, y: 42 }, { x: 50, y: 38 }, { x: 28, y: 42 }, { x: 5, y: 44 },
    { x: 65, y: 70 }, { x: 35, y: 70 },
  ],
  '3-4-3': [
    { x: 50, y: 6 },
    { x: 80, y: 22 }, { x: 50, y: 18 }, { x: 20, y: 22 },
    { x: 90, y: 44 }, { x: 63, y: 42 }, { x: 37, y: 42 }, { x: 10, y: 44 },
    { x: 85, y: 66 }, { x: 50, y: 72 }, { x: 15, y: 66 },
  ],
  '5-3-2': [
    { x: 50, y: 6 },
    { x: 95, y: 26 }, { x: 73, y: 20 }, { x: 50, y: 18 }, { x: 27, y: 20 }, { x: 5, y: 26 },
    { x: 78, y: 44 }, { x: 50, y: 42 }, { x: 22, y: 44 },
    { x: 65, y: 70 }, { x: 35, y: 70 },
  ],
  '4-1-4-1': [
    { x: 50, y: 6 },
    { x: 92, y: 24 }, { x: 67, y: 20 }, { x: 33, y: 20 }, { x: 8, y: 24 },
    { x: 50, y: 36 },
    { x: 90, y: 54 }, { x: 63, y: 52 }, { x: 37, y: 52 }, { x: 10, y: 54 },
    { x: 50, y: 74 },
  ],
  '5-4-1': [
    { x: 50, y: 6 },
    { x: 95, y: 26 }, { x: 73, y: 20 }, { x: 50, y: 18 }, { x: 27, y: 20 }, { x: 5, y: 26 },
    { x: 90, y: 46 }, { x: 63, y: 44 }, { x: 37, y: 44 }, { x: 10, y: 46 },
    { x: 50, y: 72 },
  ],
  '4-5-1': [
    { x: 50, y: 6 },
    { x: 92, y: 24 }, { x: 67, y: 20 }, { x: 33, y: 20 }, { x: 8, y: 24 },
    { x: 95, y: 46 }, { x: 72, y: 44 }, { x: 50, y: 42 }, { x: 28, y: 44 }, { x: 5, y: 46 },
    { x: 50, y: 72 },
  ],
  '3-4-1-2': [
    { x: 50, y: 6 },
    { x: 80, y: 22 }, { x: 50, y: 18 }, { x: 20, y: 22 },
    { x: 90, y: 42 }, { x: 63, y: 40 }, { x: 37, y: 40 }, { x: 10, y: 42 },
    { x: 50, y: 56 },
    { x: 65, y: 72 }, { x: 35, y: 72 },
  ],
};
