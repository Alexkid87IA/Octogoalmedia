            ...
            <div className="mt-5 space-y-4">
              ...
              <div className="pt-4 border-t border-gray-800/50">
                ...
                <div className="flex items-center gap-3">
                  ...
                  {/* Snapchat */}
                  <a href="https://snapchat.com/add/octogoal" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800/50 hover:bg-yellow-400 rounded-xl flex items-center justify-center transition-colors group">
                    <svg className="w-5 h-5 text-gray-400 group-hover:text-black transition-colors" viewBox="0 0 24 24" fill="currentColor">
