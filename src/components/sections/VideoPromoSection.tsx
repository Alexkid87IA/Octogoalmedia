...
export const VideoPromoSection: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="py-12">
        <div className="h-[400px] bg-white/[0.03] backdrop-blur-xl rounded-2xl animate-pulse border border-white/10" />
      </div>
    );
  }
            ...
            <div className="mt-5 space-y-4">
              ...
              <div className="pt-4 border-t border-white/10">
                ...
                <div className="flex items-center gap-3">
                  ...
                  {/* TikTok */}
                  <a href="https://tiktok.com/@octogoal" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/[0.05] hover:bg-white/[0.1] backdrop-blur-sm rounded-xl flex items-center justify-center transition-all group border border-white/10 hover:border-white/25">
                    <svg className="w-5 h-5 text-gray-400 group-hover:text-white transition-colors" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  {/* Twitter/X */}
                  <a href="https://twitter.com/octogoal" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/[0.05] hover:bg-white/[0.1] backdrop-blur-sm rounded-xl flex items-center justify-center transition-all group border border-white/10 hover:border-white/25">
                    <svg className="w-5 h-5 text-gray-400 group-hover:text-white transition-colors" viewBox="0 0 24 24" fill="currentColor">
          ...
          {extraits.slice(0, 4).map((extrait, index) => {
            ...
            return (
              <motion.div
                ...
                className="relative aspect-[9/16] rounded-2xl overflow-hidden bg-white/[0.03] backdrop-blur-xl border border-white/10 hover:border-white/20 transition-all group"
              >
                {isPlaying ? (
                  <iframe
