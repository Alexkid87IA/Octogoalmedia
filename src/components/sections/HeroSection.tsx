        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 mb-12">
            ...
            >
              ...
              >
                {/* Header compact */}
                <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800/50 bg-black/30">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h3 className="text-sm font-bold text-white">Flash Infos</h3>
                      <p className="text-[10px] text-gray-500">En temps réel</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-0.5">
                    <button
                      ...
                      className={`p-1 rounded transition-all ${canScrollUp ? 'text-gray-400 hover:text-white hover:bg-white/10' : 'text-gray-700'}`}
                    >
                    ...
                    <button
                      ...
                      className={`p-1 rounded transition-all ${canScrollDown ? 'text-gray-400 hover:text-white hover:bg-white/10' : 'text-gray-700'}`}
                    >
                      ...
                      return (
                        ...
                        >
                          <Link
                            ...
                            className="flex items-center gap-2.5 p-1.5 rounded-lg hover:bg-white/5 transition-colors group"
                          >
                            {/* Miniature carrée */}
                            <div className="w-11 h-11 rounded-md overflow-hidden flex-shrink-0 bg-gray-800">
                              <SafeImage
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-2 mb-0.5">
                                <span className={`text-[9px] font-bold px-1.5 py-0.5 rounded ${catStyle.text} bg-white/5`}>
                ...
                <Link
                  to="/articles"
                  className="flex items-center justify-center gap-1.5 px-4 py-2.5 border-t border-gray-800/50 text-xs text-gray-400 hover:text-pink-400 hover:bg-white/5 transition-colors"
                >
